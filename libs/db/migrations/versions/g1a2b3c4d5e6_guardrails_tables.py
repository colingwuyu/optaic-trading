...
def downgrade() -> None:
    op.drop_index(
        "ix_validation_reports_scope_target_created", table_name="validation_reports"
    )
    op.drop_index(
        op.f("ix_validation_reports_target_id"), table_name="validation_reports"
    )
    op.drop_table("validation_reports")

    op.drop_index(
        "ix_resource_contract_bundles_resource_active",
        table_name="resource_contract_bundles",
    )
    op.drop_index(
        op.f("ix_resource_contract_bundles_resource_id"),
        table_name="resource_contract_bundles",
